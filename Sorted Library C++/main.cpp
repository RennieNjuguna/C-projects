...
bool assertVectorEquals(const string&nameOfTest, const vector <int> &expected, const vector <int> &actual);
...
// Green colored text
cout << GREEN << "PASSED "<< RESET << nameOfTest << ": expected and actual lists match: {";
